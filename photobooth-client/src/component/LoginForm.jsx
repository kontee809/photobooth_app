        ...
        <main>
            <form onSubmit={handleSubmit}>
                ...
                <div className="min-h-screen flex justify-center items-center">
                    {/* Login Container */}
                    <div
                        className="flex flex-col md:flex-row bg-white shadow-lg rounded-3xl p-6 w-full max-w-4xl">

                        {/* Left Box */}
                        <div
                            className="md:w-1/2 bg-[#ffadb1] rounded-2xl flex flex-col justify-center items-center p-6 text-white">
                            <div className="mb-4">
                                <img src={cameraIcon} alt="Flower" className="w-64"/>
                            </div>
