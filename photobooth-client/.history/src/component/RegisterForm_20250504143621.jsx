                ...
                <div className="min-h-screen flex justify-center items-center bg-gray-100">
                    <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-lg">
                        ...
                        <div className="mb-4">
                            <button
                                type="button"
                                className="w-full py-3 text-sm font-medium text-white bg-[#de767e] rounded-lg hover:bg-[#c63e81] focus:bg-[#c63e81] transition"
                            >
                                Đăng kí
                            </button>
                        </div>
                        ...
                        <div className="text-center text-sm">
                            ...
                            <a href="dangnhap.html" className="text-blue-500 hover:underline">
                                Đăng nhập
                            </a>
                        </div>
                    </div>
