  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#d1cfe2] via-[#fbd3e9] to-[#ffdde1]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-16 px-4">
        {/* Template 1 */}
        <div className="border rounded-md p-6 text-center hover:scale-105 transition">
          <Link to="/camera?template=3">
            <img
              src="https://meobeostudio.com/images/3_images.png"
              alt="3 Pictures (Diagonal)"
              className="w-40 h-auto mx-auto mb-4"
            />
            <p className="font-semibold">3 Pictures (Diagonal)</p>
          </Link>
        </div>
        ...
        <div className="border rounded-md p-6 text-center hover:scale-105 transition">
          <Link to="/camera?template=4">
            <img
              ...
              className="w-40 h-auto mx-auto mb-4"
            />
            <p className="font-semibold">4 Pictures (2x2)</p>
          </Link>
        </div>
      </div>
      ...
      {/* Back Button */}
      <div className="mt-10">
        <Link to="/" className="px-6 py-2 border rounded hover:bg-black hover:text-white transition">
          BACK
        </Link>
      </div>
    </main>
